 ...
 */
public class Player2BallAdapter extends RecyclerView.Adapter<MyHolder> implements IInitAdapter{

    private List<Ball> listBall = new ArrayList<>();
    private final String TAG = "Player2BallAdapter";
    private Bitmap imgLock;
    private Bitmap imgCheck;
    public Player2BallAdapter(List<Ball> listBall, Bitmap imgLock, Bitmap imgCheck){
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.imgBall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DataUtil.updateSelectedListBall(ball.getBallId(),0,1);
